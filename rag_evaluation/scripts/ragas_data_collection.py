...
# Configuration
PROJECT_ID = "b815e1f6-31f9-4a22-b775-2db0558ab66d"
...
def collect_rag_data(project_id: str, questions: list) -> list:
    ...
    for question in questions:
        ...
        # Generate answer
        answer = prepare_prompt_and_invoke_llm(question, texts, [], tables)    # RAGAS do not take in images
...
if __name__ == "__main__":
    ...
    output_path = Path(__file__).parent.parent / "datasets" / "ragas_evaluation_dataset-1.json"
